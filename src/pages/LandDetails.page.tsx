...
const LandDetails: React.FC = () => {
    const landData = {
        ...
        ownershipDetails: {
            documentImage: "https://fahum.umsu.ac.id/blog/wp-content/uploads/2024/10/syarat-membuat-sertifikat-surat-tanah-2024.jpg",
        ...
        <CenterLayout className="bg-gray-200 p-5 ">
            ...
            <div className="p-6 bg-white min-h-screen max-w-4xl mx-auto  rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500 mb-6">
                    Lahan / <span className="text-gray-700 font-medium">Detail Lahan</span>
                </p>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span className="text-gray-700">: {landData.location.longitude}</span>
                            </div>
                            <div>
                                <span className="font-medium">Latitude</span>
                                <span className="text-gray-700">: {landData.location.latitude}</span>
                            </div>
                            <div>
                                <span className="font-medium">Luas</span>
                                <span className="text-gray-700">: {landData.location.area}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span className="text-gray-700">: {landData.landInfo.fullName}</span>
                            </div>
                            <div>
                                <span className="font-medium">Provinsi</span>
                                <span className="text-gray-700">: {landData.landInfo.province}</span>
                            </div>
                            <div>
                                <span className="font-medium">Kota/Kabupaten</span>
                                <span className="text-gray-700">: {landData.landInfo.city}</span>
                            </div>
                            <div>
                                <span className="font-medium">Kecamatan</span>
                                <span className="text-gray-700">: {landData.landInfo.district}</span>
                            </div>
                            <div>
                                <span className="font-medium">Desa/Kelurahan</span>
                                <span className="text-gray-700">: {landData.landInfo.village}</span>
                            </div>
                            <div>
                                <span className="font-medium">Alamat Lahan</span>
                                <span className="text-gray-700">: {landData.landInfo.address}</span>
                            </div>
                            <div>
                            ...
                            <div className="col-span-2">
                                ...
                                <span className="text-gray-700">: {landData.landInfo.notes}</span>
                            </div>
                        </div>
                    </div>
