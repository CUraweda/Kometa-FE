    ...
    <div className="container mx-auto p-4">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p><span className="font-semibold">Pembayaran:</span> <img src="/path-to-bca-logo.jpg" alt="BCA" className="inline w-8 h-8 ml-2" /></p>
          </div>
          <div>
            <p><span className="font-semibold">Status:</span> <span className="badge badge-warning">Tertunda</span></p>
          </div>
        </div>
